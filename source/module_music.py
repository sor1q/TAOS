...
##  ("triumph", "triumph.mp3", mtf_sit_attack),
  ...
  ("ambushed_by_sarranid", "middle_eastern_action.ogg", mtf_culture_6|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_culture_all),
...
#  ("arena_2", "arena_2.ogg", mtf_looping|mtf_sit_arena, 0),
  ...
  ("fight_4", "percussion_battery.ogg", mtf_sit_fight|mtf_sit_ambushed, 0),  
...
#  ("fight_as_swadian", "fight_as_swadian.ogg", mtf_culture_1|mtf_sit_fight, mtf_culture_all),
  ...
  ("fight_while_mounted_3", "warband_action.ogg", mtf_sit_fight|mtf_sit_ambushed, 0),
...
#  ("killed_by_vaegir", "killed_by_vaegir.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_killed, 0),
  ...
  ("enter_the_juggernaut", "enter_the_juggernaut.ogg", mtf_sit_siege, mtf_sit_fight|mtf_sit_ambushed),  
  ("siege_attempt", "siege_attempt.ogg", mtf_sit_siege, mtf_sit_fight|mtf_sit_ambushed),  
  ("crazy_battle_music", "crazy_battle_music.ogg", mtf_sit_siege, mtf_sit_fight|mtf_sit_ambushed),
