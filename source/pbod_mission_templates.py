...
real_deployment_triggers = [
 (0, 0.8, ti_once, [(mission_cam_set_screen_color, 0xFF000000)],
   [
	...
	(try_begin),
		(neg|is_camera_in_first_person),#camera_in_first_person), Wuan Fix
...
#Wuan      to add deathcam_up/down and remove key_rotate
	  #ADD
	  (this_or_next|key_clicked, "$key_camera_zoom_plus"),
      (this_or_next|key_is_down, "$key_camera_zoom_plus"),
      (this_or_next|key_clicked, "$key_camera_zoom_min"),
...
##Wuan
 ...
 (0, 0, 0, [#(eq, "$cam_mode", cam_mode_follow), #camera_follow_cycle  ##Wuan
