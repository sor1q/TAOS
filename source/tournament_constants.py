...
wp_tpe_mod_opt_award_items_on_win      = 0   # (0 - OFF / 1 - ON) With this enabled players will earn items specifiec by script_tpe_setup_loot_table upon ranking in the top 3 tournament placements.
...
MOD_ARENA_OVERHAUL_INSTALLED           = 0   # If Adorno's Arena Overhaul Mod is being used this should be set to 1.  If not, use 0.
...
# tpe_loot_item_216           = "itm_sh_swa_hea_horseman"
# tpe_loot_item_217           = "itm_ar_swa_t4_tabardmail_b"
# tpe_loot_item_218           = "itm_we_swa_blunt_morningstar"
