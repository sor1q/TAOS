...
custom_menus = [
  ...
  [
    ...
    ("cheat_add_troop_khergit_horse_archer", [], "Add 10 Sarranid Skirmishers",
        [
          (display_message, "@10 Khergit Veteran Horse Archers were added to your party."),
          (party_add_members, "p_main_party", "trp_sarranid_skirmisher", 10), 
        ] 
      ),
    ("cheat_add_troop_khergit_horse_archer", [], "Add 10 Slaver Chiefs",
        [
          (display_message, "@10 Slaver Chiefs were added to your party."),
