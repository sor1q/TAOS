     ...
     ("continue",[],"Continue...",
       ...
       #SB : randomized quick start
        (try_begin),
          ...
          (troop_set_skill, "trp_player", skl_riding, 15),
          (troop_set_skill, "trp_player", skl_power_draw, 15),
          (troop_set_skill, "trp_player", skl_power_strike, 15),
          (troop_set_skill, "trp_player", skl_inventory_management, 10),
          (change_screen_map),
        (else_try),
...
#          (try_end),
      ...
      (try_begin),
        ...
        (call_script, "script_backup_party_custom", "p_temp_party_autobattle_player", "p_main_party"),
        (try_begin),
          (ge, "$g_ally_party", 0),
          (call_script, "script_backup_party_custom", "p_temp_party_autobattle_ally", "$g_ally_party"),
        (try_end),
        (call_script, "script_backup_party_custom", "p_temp_party_autobattle_enemy", "$g_encountered_party"),
...
("order_attack_2", mnf_disable_all_keys|mnf_scale_picture,
		...
		[
			...
			(call_script, "script_init_troop_ehp_dph"),
			#(call_script, "script_calculate_damage", "p_main_party"),
			#(assign, ":player_strength", reg0),
			(call_script, "script_calculate_damage", "p_collective_friends"),
      ...
      #Soriq recalculate damage depends on troop types end
			...
			# Normalising damage: the quantity gets debuff.
			(call_script, "script_party_count_fit_for_battle", "p_collective_friends"),
			(assign, ":allies", reg0),
			(call_script, "script_party_count_fit_for_battle", "p_collective_enemy"),
			(assign, ":enemies", reg0),
			(try_begin),
				(eq, ":allies", ":enemies"), # damage not changed
			(else_try),
				(gt, ":allies", ":enemies"),
				(call_script, "script_normalise_multiplier", ":allies", ":enemies"),
				(val_mul, ":player_and_ally_strength", reg0),
				(val_div, ":player_and_ally_strength", 100),
			(else_try),
				(gt, ":enemies", ":allies"),
				(call_script, "script_normalise_multiplier", ":enemies", ":allies"),
				(val_mul, ":enemy_strength", reg0),
				(val_div, ":enemy_strength", 100),
			(try_end),

			# Checking total EHP for fast finish battle.
			(assign, ":buffer", 110), # 10% above to fix trancated division
			(call_script, "script_party_group_calculate_ehp", "p_collective_friends"),
			(store_mul, ":friends_ehp", reg0, ":buffer"),
			(val_div, ":friends_ehp", 100),
			(call_script, "script_party_group_calculate_ehp", "p_collective_enemy"),
			(store_mul, ":enemy_ehp", reg0, ":buffer"),
			(val_div, ":enemy_ehp", 100),
			(try_begin),
				(gt, ":player_and_ally_strength", ":enemy_ehp"),
				(store_mul, ":multiplier", ":enemy_ehp", 100),
				(val_div, ":multiplier", ":player_and_ally_strength"),
				(assign, ":player_and_ally_strength", ":enemy_ehp"),
				(val_mul, ":enemy_strength", ":multiplier"),
				(val_div, ":enemy_strength", 100),
			(else_try),
				(gt, ":enemy_strength", ":friends_ehp"),
				(store_mul, ":multiplier", ":friends_ehp", 100),
				(val_div, ":multiplier", ":enemy_strength"),
				(assign, ":enemy_strength", ":enemy_ehp"),
			...
			(call_script, "script_inflict_casualties_to_party_group", "$g_encountered_party", ":player_and_ally_strength", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
		...
		[
			...
			[
				(call_script, "script_autoresolver_remove_party_group", "p_main_party"),
				(call_script, "script_autoresolver_remove_party_group", "$g_encountered_party"),
      ...
      ("replay_autobattle",[(eq, "$no_soldiers_left", 1), (eq, "$replay_battle_active", 1)],"Replay Autobattle",[
          ...
          (call_script, "script_backup_restore_party_custom", "p_main_party", "p_temp_party_autobattle_player"),
          (try_begin),
            (ge, "$g_ally_party", 0),
            (party_clear, "$g_ally_party"),
            (call_script, "script_backup_restore_party_custom", "$g_ally_party", "p_temp_party_autobattle_ally"),
          (try_end),
          (call_script, "script_backup_restore_party_custom", "$g_encountered_party", "p_temp_party_autobattle_enemy"),
          
          (party_count_members_of_type, ":count", "p_main_party", "trp_player"),
          (try_begin),
              (gt, ":count", 1),
              (store_sub, ":extra", ":count", 1),
              (party_remove_members, "p_main_party", "trp_player", ":extra"),
          (try_end),
  ...
  # (
  #   "order_attack_3",mnf_disable_all_keys,
  ...
  #   ],
  #   [
  #     ("order_attack_continue",[(eq, "$no_soldiers_left", 0)],"Order your soldiers to continue the attack. (Vanilla)",[
  #         (jump_to_menu,"mnu_order_attack_3"),
  #         ]),
...
##            (eq, ":random_attribute", ca_intelligence),
  ...
  (#SB : pic hotkeys
    ...
    [
        ...
        (try_begin),
          ...
          (jump_to_menu, "mnu_total_victory"),
          (call_script, "script_autoresolver_remove_party_group", "p_main_party"),
          (call_script, "script_autoresolver_remove_party_group", "$g_enemy_party"),
          (call_script, "script_autoresolver_remove_party_group", "$g_ally_party"),
        (else_try),
  ...
  ("join_order_attack", mnf_disable_all_keys,
      ...
      (assign, ":enemy_strength", reg1),
			...
			(store_sub, ":enemy_strength_for_ally", ":enemy_strength", ":enemy_strength_for_player"),

			(val_mul, ":player_and_ally_strength", 3), # speed up
			(val_mul, ":enemy_strength_for_player", 3),
			(val_mul, ":enemy_strength_for_ally", 3),
			...
			(else_try),
				(gt, ":enemies", ":allies"),
				(call_script, "script_normalise_multiplier", ":enemies", ":allies"),
				(val_mul, ":enemy_strength_for_player", reg0),
				(val_div, ":enemy_strength_for_player", 100),
				(val_mul, ":enemy_strength_for_ally", reg0),
				(val_div, ":enemy_strength_for_ally", 100),
				(val_mul, ":enemy_strength", reg0),
				(val_div, ":enemy_strength", 100),
			(try_end),

			# Chacking total EHP for fast finish battle.
			(assign, ":buffer", 110), # 10% above to fix trancated division
			(call_script, "script_party_group_calculate_ehp", "p_collective_friends"),
			(store_mul, ":friends_ehp", reg0, ":buffer"),
			(val_div, ":friends_ehp", 100),
			...
			(try_begin),
				...
				(val_div, ":multiplier", ":player_and_ally_strength"),
				(assign, ":player_and_ally_strength", ":enemy_ehp"),
				(val_mul, ":enemy_strength_for_player", ":multiplier"),
				(val_div, ":enemy_strength_for_player", 100),
				(val_mul, ":enemy_strength_for_ally", ":multiplier"),
				(val_div, ":enemy_strength_for_ally", 100),
			(else_try),
				(gt, ":enemy_strength", ":friends_ehp"),
				(store_mul, ":multiplier", ":friends_ehp", 100),
			...
			#(try_begin),
			#  (gt, "$cheat_mode", 0),
			#  (assign, reg0, ":player_and_ally_strength"),
			#  (assign, reg1, ":enemy_strength_for_player"),
			#  (assign, reg2, ":enemy_strength_for_ally"),
			#  (display_message, "@{!}Friends {reg0}, enemy for Player {reg1}, enemy for ally {reg2}"),
			#(try_end),

			(call_script, "script_inflict_casualties_to_party_group", "p_main_party", ":enemy_strength_for_player", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s8, s0),
			
			(call_script, "script_inflict_casualties_to_party_group", "$g_enemy_party", ":player_and_ally_strength", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			...
			(call_script, "script_inflict_casualties_to_party_group", "$g_ally_party", ":enemy_strength_for_ally", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s9, s0),
 ...
 {reg4} hours.",
   ...
   ("castle_attack_walls_simulate", mnf_disable_all_keys|mnf_scale_picture,
		...
		[ 
			...
			(val_mul, ":player_damage", 3),
			(val_div, ":player_damage", 4),
			(call_script, "script_calculate_damage", "$g_encountered_party"),
      ...
      (assign, ":enemy_damage", reg1),
			...
			(else_try),
				(gt, ":allies", ":enemies"),
				(call_script, "script_normalise_multiplier", ":allies", ":enemies"),
				(val_mul, ":player_damage", reg0),
				(val_div, ":player_damage", 100),
			(else_try),
				(gt, ":enemies", ":allies"),
				(call_script, "script_normalise_multiplier", ":enemies", ":allies"),
				(val_mul, ":enemy_damage", reg0),
				(val_div, ":enemy_damage", 100),
			(try_end),
			...
			(val_div, ":enemy_ehp", 100),
			(try_begin),
				(gt, ":player_damage", ":enemy_ehp"),
				(store_mul, ":multiplier", ":enemy_ehp", 100),
				(val_div, ":multiplier", ":player_damage"),
				(assign, ":player_damage", ":enemy_ehp"),
				(val_mul, ":enemy_damage", ":multiplier"),
				(val_div, ":enemy_damage", 100),
			(else_try),
				(gt, ":enemy_damage", ":friends_ehp"),
				(store_mul, ":multiplier", ":friends_ehp", 100),
				(val_div, ":multiplier", ":enemy_damage"),
				(assign, ":enemy_damage", ":enemy_ehp"),
				(val_mul, ":player_damage", ":multiplier"),
				(val_div, ":player_damage", 100),
			(try_end),

			(call_script, "script_inflict_casualties_to_party_group", "p_main_party", ":enemy_damage", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s8, s0),
			
			(call_script, "script_inflict_casualties_to_party_group", "$g_encountered_party", ":player_damage", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s9, s0),
   ...
   ("castle_attack_walls_with_allies_simulate", mnf_disable_all_keys|mnf_scale_picture,
		...
		[
			...
			(val_div, ":player_strength", 4),
			(call_script, "script_calculate_damage", "p_collective_friends"),
			(assign, ":ally_strength", reg0),
			(val_mul, ":ally_strength", 3),
			(val_div, ":ally_strength", 4),
			(call_script, "script_calculate_damage", "p_collective_enemy"),
			(assign, ":enemy_strength", reg0),
			...
			(store_add, ":ally_with_player_strength", ":player_strength", ":ally_strength"),
			(store_mul, ":enemy_for_player_strength", ":enemy_strength", ":player_strength"),
			(val_div, ":enemy_for_player_strength", ":ally_with_player_strength"),
			(store_sub, ":enemy_for_ally_strength", ":enemy_strength", ":enemy_for_player_strength"),
			...
			(else_try),
				(gt, ":allies", ":enemies"),
				(call_script, "script_normalise_multiplier", ":allies", ":enemies"),
				(val_mul, ":ally_with_player_strength", reg0),
				(val_div, ":ally_with_player_strength", 100),
			(else_try),
				(gt, ":enemies", ":allies"),
				(call_script, "script_normalise_multiplier", ":enemies", ":allies"),
				(val_mul, ":enemy_for_player_strength", reg0),
				(val_div, ":enemy_for_player_strength", 100),
				(val_mul, ":enemy_for_ally_strength", reg0),
				(val_div, ":enemy_for_ally_strength", 100),
				(val_mul, ":enemy_strength", reg0),
				(val_div, ":enemy_strength", 100),
			(try_end),
			...
			(val_div, ":enemy_ehp", 100),
			(try_begin),
				(gt, ":ally_with_player_strength", ":enemy_ehp"),
				(store_mul, ":multiplier", ":enemy_ehp", 100),
				(val_div, ":multiplier", ":ally_with_player_strength"),
				(assign, ":ally_with_player_strength", ":enemy_ehp"),
				(val_mul, ":enemy_for_player_strength", ":multiplier"),
				(val_div, ":enemy_for_player_strength", 100),
				(val_mul, ":enemy_for_ally_strength", ":multiplier"),
				(val_div, ":enemy_for_ally_strength", 100),
			(else_try),
				(gt, ":enemy_strength", ":friends_ehp"),
				(store_mul, ":multiplier", ":friends_ehp", 100),
				(val_div, ":multiplier", ":enemy_strength"),
				(assign, ":enemy_strength", ":enemy_ehp"),
				(store_mul, ":enemy_for_player_strength", ":enemy_strength", "$g_strength_contribution_of_player"),
				(val_div, ":enemy_for_player_strength", 100),
				(store_sub, ":enemy_for_ally_strength", ":enemy_strength", ":enemy_for_player_strength"),
				(val_mul, ":ally_with_player_strength", ":multiplier"),
				(val_div, ":ally_with_player_strength", 100),
			(try_end),
			
			(call_script, "script_inflict_casualties_to_party_group", "p_main_party", ":enemy_for_player_strength", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s8, s0),

			(call_script, "script_inflict_casualties_to_party_group", "$g_enemy_party", ":ally_with_player_strength", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s10, s0),
			
			(call_script, "script_collect_friendly_parties"),
			(call_script, "script_inflict_casualties_to_party_group", "$g_ally_party", ":enemy_for_ally_strength", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s9, s0),
			(party_collect_attachments_to_party, "$g_enemy_party", "p_collective_enemy"),
			(assign, "$no_soldiers_left", 0),
  ...
  ("siege_join_defense", mnf_disable_all_keys|mnf_scale_picture,
		...
		[
			...
			(try_begin),
				...
				(call_script, "script_calculate_damage", "p_main_party"),
				(assign, ":player_strength", reg0),
				(val_mul, ":player_strength", 13),
				(val_div, ":player_strength", 10),
			(else_try),
				(assign, ":player_strength", 0),
			(end_try),
			(call_script, "script_calculate_damage", "p_collective_friends"),
			(assign, ":ally_strength", reg0),
			(val_mul, ":ally_strength", 13),
			(val_div, ":ally_strength", 10),
			(call_script, "script_calculate_damage", "p_collective_enemy"),
			(assign, ":enemy_strength", reg0),
			(val_mul, ":enemy_strength", 3),
			(val_div, ":enemy_strength", 4),
			(store_add, ":ally_and_player_strength", ":player_strength", ":ally_strength"),
			(store_mul, ":enemy_for_player_strength", ":enemy_strength", ":player_strength"),
			(val_div, ":enemy_for_player_strength", ":ally_and_player_strength"),
			(store_sub, ":enemy_for_ally_strength", ":enemy_strength", ":enemy_for_player_strength"),
			...
			(else_try),
				(gt, ":allies", ":enemies"),
				(call_script, "script_normalise_multiplier", ":allies", ":enemies"),
				(val_mul, ":ally_and_player_strength", reg0),
				(val_div, ":ally_and_player_strength", 100),
			(else_try),
				(gt, ":enemies", ":allies"),
				(call_script, "script_normalise_multiplier", ":enemies", ":allies"),
				(val_mul, ":enemy_for_player_strength", reg0),
			...
			(val_div, ":enemy_ehp", 100),
			(try_begin),
				(gt, ":ally_and_player_strength", ":enemy_ehp"),
				(store_mul, ":multiplier", ":enemy_ehp", 100),
				(val_div, ":multiplier", ":ally_and_player_strength"),
				(assign, ":ally_and_player_strength", ":enemy_ehp"),
				(val_mul, ":enemy_for_player_strength", ":multiplier"),
				(val_div, ":enemy_for_player_strength", 100),
				(val_mul, ":enemy_for_ally_strength", ":multiplier"),
				(val_div, ":enemy_for_ally_strength", 100),
			(else_try),
				...
				(val_div, ":enemy_for_player_strength", 100),
				(store_sub, ":enemy_for_ally_strength", ":enemy_strength", ":enemy_for_player_strength"),
				(val_mul, ":ally_and_player_strength", ":multiplier"),
				(val_div, ":ally_and_player_strength", 100),
			(try_end),
			...
			(call_script, "script_inflict_casualties_to_party_group", "$g_enemy_party", ":ally_and_player_strength", "p_temp_casualties"),
			(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
			(str_store_string_reg, s10, s0),
			(party_collect_attachments_to_party, "$g_enemy_party", "p_collective_enemy"),
			(try_begin),
       ...
       [
         ...
         (else_try),
           ...
           (else_try), #SB : wtf is this
             (assign,reg0,"trp_syndicate_enforcer"),
             (assign,reg1,"trp_syndicate_enforcer"),
             (assign,reg2,"trp_syndicate_sentry"),
             (assign,reg3,"trp_syndicate_contractor"),
           (try_end),
           (shuffle_range,0,4),
