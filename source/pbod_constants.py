...
slot_party_pref_formations   = slot_town_arena_melee_2_num_teams #82
slot_party_pref_bodyguard    = slot_town_arena_melee_2_team_size #83
slot_party_pref_bc_continue  = slot_town_arena_melee_3_num_teams #84
slot_party_pref_bc_charge_ko = slot_town_arena_melee_3_team_size #85
slot_party_pref_wp_prof_decrease = slot_town_arena_melee_cur_tier#86
...
keys_list = [
	          ...
	          ("$key_camera_left",     key_a,              "Camera Left"),
	          ("$key_camera_right",    key_d,             "Camera Right"),
			  ("$key_camera_zoom_plus",key_space,           "Camera Up"),
              ("$key_camera_zoom_min", key_left_control,            "Camera Down"),
	          ...
	          ("$key_special_whistle", key_v,                 "Call Horse / Rear"),
			  ("$key_special_pavise",  key_n,                 "Deploy/Recover Pavise^Fire Arrows"),
			  ("$key_special_bash",    key_middle_mouse_button,             "Shield Bash Attack"),	  
			  ("$key_special_crouch",  key_z,         "Crouch / Cheer"),
            ] # end of keys_list
...
(key_space, "Space Bar"), (key_escape, "Escape"), (key_enter, "Enter"), (key_tab, "Tab"), (key_back_space, "Backspace"), 
...
key_label_begin = "str_key_0"#1"    Wuan
