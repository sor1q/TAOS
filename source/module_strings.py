...
troop_tree_strings = [
  #!#MOD BEGIN - troop tree
    ...
    ("ui_int","INT"),
    ("ui_cha","CHA"),
    ("skl_trade_name","Trade"),
    ("skl_leadership_name","Leadership"),
    ("skl_prisoner_management_name","Prisoner Management"),
    ("skl_reserved_1_name","Reserved Skill 1"),
    ("skl_reserved_2_name","Reserved Skill 2"),
    ("skl_reserved_3_name","Reserved Skill 3"),
    ("skl_reserved_4_name","Reserved Skill 4"),
    ("skl_persuasion_name","Persuasion"),
    ("skl_engineer_name","Engineer"),
    ("skl_first_aid_name","First Aid"),
    ("skl_surgery_name","Surgery"),
    ("skl_wound_treatment_name","Wound Treatment"),
    ("skl_inventory_management_name","Inventory Management"),
    ("skl_spotting_name","Spotting"),
    ("skl_pathfinding_name","Path-finding"),
    ("skl_tactics_name","Tactics"),
    ("skl_tracking_name","Tracking"),
    ("skl_trainer_name","Trainer"),
    ("skl_reserved_5_name","Reserved Skill 5"),
    ("skl_reserved_6_name","Reserved Skill 6"),
    ("skl_reserved_7_name","Reserved Skill 7"),
    ("skl_reserved_8_name","Reserved Skill 8"),
    ("skl_looting_name","Looting"),
    ("skl_horse_archery_name","Horse Archery"),
    ("skl_riding_name","Riding"),
    ("skl_athletics_name","Athletics"),
    ("skl_shield_name","Shield"),
    ("skl_weapon_master_name","Weapon Master"),
    ("skl_reserved_9_name","Reserved Skill 9"),
    ("skl_reserved_10_name","Reserved Skill 10"),
    ("skl_reserved_11_name","Reserved Skill 11"),
    ("skl_reserved_12_name","Reserved Skill 12"),
    ("skl_reserved_13_name","Reserved Skill 13"),
    ("skl_power_draw_name","Power Draw"),
    ("skl_power_throw_name","Power Throw"),
    ("skl_power_strike_name","Power Strike"),
    ("skl_ironflesh_name","Ironflesh"),
    ("skl_reserved_14_name","Reserved Skill 14"),
    ("skl_reserved_15_name","Reserved Skill 15"),
    ("skl_reserved_16_name","Reserved Skill 16"),
    ("skl_reserved_17_name","Reserved Skill 17"),
    ("skl_reserved_18_name","Reserved Skill 18"),
    ("ui_one_handed_weapons","One-handed"),#!#feel free to replace with whatever other values you have in ui.csv under the same name, so it matches
    ("ui_two_handed_weapons","Two-handed"),
    ("ui_polearms","Polearms"),
    ("ui_archery","Archery"),
    ("ui_crossbows","Crossbows"),
    ("ui_throwing","Throwing"),
    ("ui_firearms","Firearms"),
    #!#MOD END - troop tree
]
...
##diplomacy end+
  ...
  ("north", "The North"),
  ("syndicate", "The Ost-Gart Syndicate"),
  ("kara_thar", "Empire of Kara-Thar"),
  ("ashkar", "Ashkar Confederation"),
  ("solmark", "Solmark Inquisition"),
  ("eirven", "Union of Eirven"),
  ("vallor", "Kingdom of Vallor"),
  ("bandits", "bandits"),
  ("deserters", "deserters"),
  ("your_followers", "your followers"),
