...
#Shield Bash Script - Xenoargh (Blood & Steel); edited/reworked per comments in the thread, etc, by Caba
 ("cf_shield_bash",
   [  
    ...
    (set_fixed_point_multiplier, 100),
	(item_get_weapon_length, ":shield_width", ":shield_item"),
	(item_get_shield_height, ":shield_height", ":shield_item"),
	(val_add, ":shield_height", ":shield_width"),
	(val_mul, ":shield_width", 2),
	#debug
    #(assign, reg1, ":shield_height"),
	#(assign, reg2, ":shield_width"),
	#(display_message, "@shield height : {reg1} cm, shield width : {reg2} cm"),
	#debug
	(this_or_next|ge, ":shield_height", 50),
	(ge, ":shield_width", 50),
	##Wuan Fix
...
#-- Dunde's Key Config END
 ...
 ("cf_agent_recover_pavise",
   [
	...
	(agent_equip_item, ":agent", ":item", ":ek_slot", ":modifier"),
    ##Wuan
