...
skills = [
  ...
  ("engineer","Engineer",sf_base_att_int|sf_effects_party,12,"This skill allows you to construct siege equipment and fief improvements more efficiently. (Party skill)"),
  ...
  ("pathfinding","Path-finding",sf_base_att_int|sf_effects_party,12,"Party map speed is increased by 3%% per skill level. (Party skill)"), 
