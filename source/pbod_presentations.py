...
presentations = [
 ...
 ("pbod_preferences", 0, mesh_load_window, [
    (ti_on_presentation_load,
       [
        ...
        (create_text_overlay, reg0, "@Preference Description__________________Setting", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		...
		(create_text_overlay, reg0, "@Enable AI Skirmishing:", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		(create_text_overlay, reg0, "@Enable AI Volley Fire:", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		(create_text_overlay, reg0, "@Enable AI Deploy Pavise Shields:", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		
		(store_add, ":line_4_y", ":headings_y", ":line_y_shift"), #LINE 4 HERE
		...
		(store_add, ":line_5_y", ":headings_y", ":line_y_shift"), #LINE 5 HERE
		...
		(create_text_overlay, reg0, "@R.Dply. Phase Time Slowing:", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
		(val_sub, ":headings_y", ":cur_y_shift"),
		...
		# (create_slider_overlay, reg0, 1, 10), #Time Scale Slider
        # (position_set_x, pos1, 485),
		# (val_sub, ":inputs_y", 8),
		# (position_set_y, pos1, ":inputs_y"),
        # (overlay_set_position, reg0, pos1),	
		...
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #AI Spear Brace/Special Orders beginning
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),	
        (val_sub, ":inputs_y", ":cur_y_shift"),	
		
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #AI Skirmish
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),	
        (val_sub, ":inputs_y", ":cur_y_shift"),	
		
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #AI Volley
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),	
        (val_sub, ":inputs_y", ":cur_y_shift"),	
		
		(create_check_box_overlay, reg0, "mesh_checkbox_off", "mesh_checkbox_on"), #AI Deploy Pavise
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, reg0, pos1),	
        (val_sub, ":inputs_y", ":cur_y_shift"),	
		...
		(create_combo_button_overlay, reg0), #Time Slowing Scale
		(position_set_x, pos1, 485),
		(val_sub, ":inputs_y", 8),
		(position_set_y, pos1, ":inputs_y"),
		(overlay_set_position, reg0, pos1),
		...
		(overlay_add_item, reg0, "@Faster"),
		(overlay_add_item, reg0, "@Fastest"),
		(position_set_x, pos1, 450),
		(val_add, ":inputs_y", 8),
		(val_sub, ":inputs_y", ":cur_y_shift"),			
		...
		(party_get_slot, ":pref_timescale", "p_main_party", slot_party_pref_rdep_time_scale),
		(party_get_slot, ":pref_spobrace", "p_main_party", slot_party_pref_spo_brace),
		(party_get_slot, ":pref_sposkirmish", "p_main_party", slot_party_pref_spo_skirmish),
		(party_get_slot, ":pref_spovolley", "p_main_party", slot_party_pref_spo_volley),
		(party_get_slot, ":pref_spopavise", "p_main_party", slot_party_pref_spo_pavise),
		...
		(val_add, ":overlay", 1),
		(overlay_set_val, ":overlay", ":pref_spobrace"),
		(val_add, ":overlay", 1),
		(overlay_set_val, ":overlay", ":pref_sposkirmish"),
		(val_add, ":overlay", 1),
		(overlay_set_val, ":overlay", ":pref_spovolley"),
		(val_add, ":overlay", 1),
		(overlay_set_val, ":overlay", ":pref_spopavise"),
		(val_add, ":overlay", 1),		
		(overlay_set_val, ":overlay", ":pref_bodyguard"),
		(val_add, ":overlay", 1),
		(overlay_set_val, ":overlay", ":pref_wpnprofd"),
		(val_add, ":overlay", 3), #skip the 2 globals
		(overlay_set_val, ":overlay", ":pref_timescale"),
		...
		(try_end),		
		(str_store_string, s1, "@Version 0.{s1}"),
    ...
    (ti_on_presentation_event_state_change,
       [
        ...
        (else_try),
		  (val_add, ":overlay", 1),
		  (eq, ":object", ":overlay"), #AI Spear Brace/Special Orders begin
		  (party_set_slot, "p_main_party", slot_party_pref_spo_brace, ":value"),	
        (else_try),
		  (val_add, ":overlay", 1),
		  (eq, ":object", ":overlay"),
		  (party_set_slot, "p_main_party", slot_party_pref_spo_skirmish, ":value"),	
        (else_try),
		  (val_add, ":overlay", 1),
		  (eq, ":object", ":overlay"), 
		  (party_set_slot, "p_main_party", slot_party_pref_spo_volley, ":value"),	
        (else_try),
		  (val_add, ":overlay", 1),
		  (eq, ":object", ":overlay"), 
		  (party_set_slot, "p_main_party", slot_party_pref_spo_pavise, ":value"),			  	  
		(else_try),
		  (val_add, ":overlay", 1),
		...
		(else_try),
		  (val_add, ":overlay", 1),
		  (eq, ":object", ":overlay"), #Deployment Time Scale
		  (party_set_slot, "p_main_party", slot_party_pref_rdep_time_scale, ":value"),
        (try_end),
       ]),
	   ...
	   [
		...
		(else_try),
			...
			(else_try),
			  ...
			  (eq, ":object", ":overlay"), #Lancer		  
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Weapon Use Fix for Lancers will force mounted bots with lances to use them unless they are surrounded by enemies. (Only active in field battles.)"),       
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #Horse Archer
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Weapon Use Fix for Horse Archers will force mounted bots with bows to use them until they run out of ammo. (Only active in field battles.)"),       
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #Spear
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Weapon Use Fix for Spear/Polearms will force infantry bots with polearms to use them unless they are surrounded by enemies. (Only active in field battles.)"),       
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #Damage
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Damage tweaks will give a flat boost to damage from spears to horses, and charge damage from horses to infantry, in an attempt to compensate for poor AI use of polearms and charges. (Only active in field battles.)"),        
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"),  #De-horsed
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Mounted bots, once their horse dies, can be re-assinged to a division of your choosing. If active, AI bots will be reassigned to infantry. (Only active in field battles.)"),       	
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #Out of Ammo
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Foot archer bots, once out of ammo, can be re-assinged to a division of your choosing. If active, AI bots will be reassigned to infantry. (Only active in field battles.)"),	
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #Deployment
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Real Deployment allows you to position your troops on the field before the battle begins.^To access this feature, begin the battle by chosing 'Take the Field' or creating and using a pre-battle plan.^^If you experience problems with this feature, see the Time Slowing option below."),
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			...
			(else_try),
			  ...
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #AI Formations
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Select your prefered Battle AI: Disabled is Native AI; Formations AI both allows the AI to use formations and changes their battle decision-making; Native AI w/Formations is Native AI but carries out the Native AI with basic formations. (Only active in field battles.)"),
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #AI Spear Brace/Special Orders Begin
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Enabling AI Special Orders allows the AI teams to use volley fire and pavise deployment (crossbows), skirmish mode (bow-users), and spear-bracing (polearm infantry). (Only active in field battles.)"),
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #AI Skrimish
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Enabling AI Special Orders allows the AI teams to use volley fire and pavise deployment (crossbows), skirmish mode (bow-users), and spear-bracing (polearm infantry). (Only active in field battles.)"),
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #AI Volley
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Enabling AI Special Orders allows the AI teams to use volley fire and pavise deployment (crossbows), skirmish mode (bow-users), and spear-bracing (polearm infantry). (Only active in field battles.)"),
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #AI Deploy Pavise
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Enabling AI Special Orders allows the AI teams to use volley fire and pavise deployment (crossbows), skirmish mode (bow-users), and spear-bracing (polearm infantry). (Only active in field battles.)"),
			(else_try),
			  (val_add, ":overlay", 1),
			  (val_add, ":overlay_2", 1),
			...
			(else_try),
			  ...
			  (this_or_next|eq, ":object", ":overlay_2"),
			  (eq, ":object", ":overlay"), #Deployment Time Scale
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@If you are having difficulties with the Real Deployment feature not working appropriately, adjust the value of this 'time slowing' scale until the feature works on your machine. Otherwise, feel free to ignore this option."),		
			(else_try),	
			  (overlay_set_text, "$g_presentation_obj_banner_selection_1", "@Mouse-over options for further information."),
			(try_end),
		(try_end),	  
 ...
 ("pbod_redefine_keys", 0, mesh_load_window, [
   (ti_on_presentation_load, 
    [(presentation_set_duration, 999999),
     ...
     # (overlay_set_position, reg0, pos1), (overlay_set_size, reg0, pos2),	
     ##Wuan Modified     
     (position_set_y, pos1, 100), (position_set_x, pos1, 100),   # Notes' Position 
     (position_set_x, pos2, 1000), (position_set_y, pos2, 1000), # Note's Size
     (create_text_overlay, "$g_presentation_credits_obj_4", "@Be careful not to conflict with the native controls", tf_left_align),
     ##Wuan Modified
     (overlay_set_position, "$g_presentation_credits_obj_4", pos1), 
	 (overlay_set_size, "$g_presentation_credits_obj_4", pos2),
     (overlay_set_color, "$g_presentation_credits_obj_4", 0x600000),  # Note's Color  was 600000 678000
     (overlay_set_alpha, "$g_presentation_credits_obj_4", 0x00),      # Note's invisible  
	 ...
	 # Other Buttons
	 (create_game_button_overlay, "$g_presentation_credits_obj_5", "@OK", tf_center_justify),          # OK Button
	 (create_game_button_overlay, "$g_presentation_credits_obj_6", "@Reset", tf_center_justify),       # RESET Button
	 (create_game_button_overlay, "$g_presentation_credits_obj_7", "@Default", tf_center_justify),     # DEFAULT Button
	 (create_game_button_overlay, "$g_presentation_credits_obj_8", "@Disable All"),                    # DISABLE ALL Button
	 # Rearrange Buttons
     (position_set_y, pos1, 25), 
	 (position_set_x, pos1, 900),         (overlay_set_position, "$g_presentation_credits_obj_5", pos1),
     (position_set_x, pos1, 900 - 1*160), (overlay_set_position, "$g_presentation_credits_obj_6", pos1),   
     (position_set_x, pos1, 900 - 2*160), (overlay_set_position, "$g_presentation_credits_obj_7", pos1),  
     (position_set_x, pos1, 900 - 3*160), (overlay_set_position, "$g_presentation_credits_obj_8", pos1),
	 # (create_game_button_overlay, "$g_presentation_credits_obj_9", "@Mod Options"),
     # (position_set_x, pos1, 900),(position_set_y, pos1, 75),(overlay_set_position, "$g_presentation_credits_obj_9", pos1),
	]),
   ...
   (ti_on_presentation_event_state_change, 
    [(store_trigger_param_1, ":object"),
     ...
     (try_for_range, ":slot", slot_key_overlay_begin, ":upper_limit"),       # for all KeyConfigs Button Overlay
        ...
        (assign, "$g_presentation_credits_obj_3", 1),                              # Flag the event
     ...
     #Mouse Dead-Zone addition
	 (else_try),
	   (store_sub, ":overlay", "$g_presentation_credits_obj_5", 1),
	   (eq, ":object", ":overlay"),
	   (store_trigger_param_2, ":value"),
	 ...
	 #Mouse Dead-Zone addition end
	 (else_try),    
       (eq, ":object", "$g_presentation_credits_obj_5"),     # OK pressed?
     ...
     (else_try),    
       (eq, ":object", "$g_presentation_credits_obj_6"),     # RESET pressed? 
     ...
     (else_try),
       (eq, ":object", "$g_presentation_credits_obj_7"),     # DEFAULT pressed?
       (call_script, "script_reset_to_default_keys"),                       # Reload Default Config
       (call_script, "script_update_key_config_buttons"),                   # Update Captions 
	 (else_try),
       (eq, ":object", "$g_presentation_credits_obj_8"),     # DISABLE ALL pressed?
       (try_for_range, ":no", slot_keys_begin, slot_keys_begin + number_of_keys),           
           (troop_set_slot, key_config_data, ":no", 0xff),                          # Disable all keys
       (try_end),
       (call_script, "script_update_key_config_buttons"),                           # Update Captions 
     # (else_try),
       # (eq, ":object", "$g_presentation_credits_obj_9"),     # RETURN TO PREFERENCES
	   # (call_script, "script_set_global_var_key_config"),                   # Write the Config to Global Variable
	   # (start_presentation, "prsnt_pbod_preferences"),                      # Go To Preferences
	   ##(start_presentation, "prsnt_mod_option"),
     (try_end),
     (try_begin),
        (eq, "$g_presentation_credits_obj_3", 1),                    # if a Button's waiting to set 
        (overlay_set_alpha, "$g_presentation_credits_obj_4", 0xFF),  # then make The Note visible
     (try_end), ]),
  ...
  (ti_on_presentation_run, 
   [(eq, "$g_presentation_credits_obj_3", 1),                                     # if a Button's waiting to set 
    ...
    (else_try),
       (assign, "$g_presentation_credits_obj_3", 1),          # else? do nothing. The Button's still waiting
    (try_end),
    (try_begin),
       (eq, "$g_presentation_credits_obj_3", 0),                     # if there's new keyconfig for the button
       (try_for_range, ":no", slot_keys_begin, slot_keys_begin + number_of_keys),   # Check if there is another button use the same key
		   ...
		   #CABA - to allow these to be death-camera specific and not a conflict problem
		   (neg|is_between, "$g_presentation_credits_obj_2", key_ignore_check_begin, key_ignore_check_end),
		   (neg|is_between, ":no", key_ignore_check_begin, key_ignore_check_end),
		   #CABA - to allow these to be death-camera specific and not a conflict problem
       ...
       (overlay_set_alpha, "$g_presentation_credits_obj_4", 0x00),   # The Note must be dissapear again
       (call_script, "script_update_key_config_buttons"),                           # Update Captions
    (try_end), 
    ]),  
   ]),      
	
 ("caba_order_display", prsntf_read_only|prsntf_manual_end_only,0,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
		(try_for_range, ":i", 0, 9),
		...
		(try_begin), #Figure out which orders to display, set strings
			...
			(try_begin),
				...
				(str_store_string, s5, "@{s14} - Special orders"),
			
				(assign, ":num_orders", 5),
			(else_try),
				(str_store_string, s1, "@{s11} - Weapon orders"),
				(str_store_string, s2, "@{s12} - Shield orders"),
				(str_store_string, s3, "@{s14} - Special orders"),
			
				(assign, ":num_orders", 3),
			(try_end),
			(assign, ":y_position", 473),
		(else_try),
		    (team_slot_eq, 2, slot_team_mv_gk_order, gk_order_4),
            ...
            (assign, ":num_orders", 6),
		(else_try),	
			(team_slot_eq, 2, slot_team_mv_gk_order, gk_order_5),
            ...
            (assign, ":num_orders", 5),
		(else_try),
			(team_slot_eq, 2, slot_team_mv_gk_order, gk_order_6),
            ...
            (assign, ":num_orders", 4),
		(else_try),
			(team_slot_eq, 2, slot_team_mv_gk_order, "$key_order_7"),
			(str_store_string, s1, "@{s10} - End Order"),
			(str_store_string, s2, "@{s11} - Skirmish"),
			(str_store_string, s3, "@{s12} - Deploy Pavise Shields"),
			(str_store_string, s4, "@{s13} - Brace Polearms"),
			(str_store_string, s5, "@{s15} - Escape Menu"),
			
            (assign, ":num_orders", 5),
		(else_try),
			(team_slot_eq, 2, slot_team_mv_gk_order, "$key_order_8"),
			(str_store_string, s1, "@{s11} - Ignite Fire Arrows"),
			(str_store_string, s2, "@{s12} - Extinguish Fire Arrows"),
			(str_store_string, s3, "@{s13} - Crouch"),
			(str_store_string, s4, "@{s14} - Stand"),
			(str_store_string, s5, "@{s15} - Escape Menu"),
			
            (assign, ":num_orders", 5),
		(else_try),
			(team_slot_eq, 2, slot_team_mv_gk_order, gk_order_2),
			(str_store_string, s1, "@{s13} - Add one rank"),
			(str_store_string, s2, "@{s14} - Remove one rank"),	
			(str_store_string, s3, "@{s15} - Escape Menu"),			
			(assign, ":num_orders", 3),
			(assign, ":y_position", 383),
		(else_try),
			(team_slot_eq, 2, slot_team_mv_gk_order, gk_order_3),
			(str_store_string, s1, "@{s11} - Fire in volleys"),
			(str_store_string, s2, "@{s12} - Fire by rank"),	
			(str_store_string, s3, "@{s13} - Fire by platoon"),
			(str_store_string, s4, "@{s15} - Escape Menu"),				
			(assign, ":num_orders", 4),
			(assign, ":y_position", 443),
		(try_end),
		(team_get_slot, ":starting_order", 2, slot_team_mv_gk_order),
		(team_set_slot, 3, slot_team_mv_gk_order_backup, ":starting_order"),
		
		(try_begin),
			#(neg|team_slot_eq, 2, slot_team_mv_gk_order, 0),
			(neq, ":starting_order", 0),
			(neq, ":starting_order", gk_order_2),
			(neq, ":starting_order", gk_order_3),
	...
	(ti_on_presentation_run,
       [(store_trigger_param_1, ":cur_time"),
        (gt, ":cur_time", 50), #100 0.1 Second after Pres. Start
        (try_begin),
        ...
        (else_try),
			...
			#(close_order_menu), #WSE
			(try_begin),
			    (team_slot_eq, 3, slot_team_mv_gk_order_backup, 0),
		        (presentation_set_duration, 0),
			(else_try),
				(assign, ":nul_key", 99),
			    (try_begin),
					(team_slot_eq, 3, slot_team_mv_gk_order_backup, gk_order_4),
					(assign, ":min_key", 4),
					(assign, ":max_key", 8),
				(else_try),
					(team_slot_eq, 3, slot_team_mv_gk_order_backup, gk_order_5),
					(assign, ":min_key", 5),
					(assign, ":max_key", 8),
				(else_try),
				    (team_slot_eq, 3, slot_team_mv_gk_order_backup, gk_order_6),
					(assign, ":min_key", 5),
					(assign, ":max_key", 7),
				(else_try),
				    (team_slot_eq, 3, slot_team_mv_gk_order_backup, "$key_order_7"),
					(assign, ":min_key", 4),
					(assign, ":max_key", 7),
				(else_try),
				    (team_slot_eq, 3, slot_team_mv_gk_order_backup, "$key_order_8"),
					(assign, ":min_key", 5),
					(assign, ":max_key", 8),
				(else_try),
				    (assign, ":nul_key", 4),
				    (team_slot_eq, 3, slot_team_mv_gk_order_backup, gk_order_2),
					(assign, ":min_key", 7),
					(assign, ":max_key", 8), 
					(is_between, ":key", 7, 9),
					(close_order_menu), #WSE
				(else_try),
				    (team_slot_eq, 3, slot_team_mv_gk_order_backup, gk_order_3),
					(assign, ":min_key", 5),
					(assign, ":max_key", 7),
					(is_between, ":key", 5, 8),
					(close_order_menu), #WSE					
				...
				(this_or_next|is_between, ":key", ":nul_key", ":min_key"),
 ...
 ("caba_camera_mode_display", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
      [
        (set_fixed_point_multiplier, 1000),
...
def modmerge_presentations(orig_presentations):
	...
	try:
		...
		codeblock.InsertBefore(pos, [
		   ...
		   (else_try),
			 ...
			 (try_begin),
				...
				(party_set_slot, "p_main_party", slot_party_pref_spo_pavise, 1),
		...
		pos = codeblock.FindLineMatching(change_screen_mission, 0, D_SEARCH_FROM_BOTTOM)
		codeblock.InsertBefore(pos, [(party_slot_eq, "p_main_party", slot_party_pref_real_deployment, 1),
